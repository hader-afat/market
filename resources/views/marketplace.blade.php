    ...
    <div class = "container mb-5 my-3" style = "height : max">
        <div class="row align-items-center" style = "height : 500px">
            ...
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/whiteshirt.jpg" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
            ...
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/yellowshirt.jpg" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
        ...
        <div class="row align-items-center" style = "height : 500px">
            ...
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/coffeem.jfif" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                            <div class = "typea">
                                <a href = "#" class = "aa">Coffee Machine </a>
                                <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                            </div>   
                            <a href = "#" class = "pricea aa">499 EGP</a>
                    </div>
                </div>
            </div>
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    ...
                    <div class = "detail-boxa">
                            <div class = "typea">
                                <a href = "#" class = "aa">Smart TV </a>
                                <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                            </div>   
                            <a href = "#" class = "pricea aa">7000 EGP</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row align-items-center" style = "height : 500px">
            ...
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/chair.jpg" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                            <div class = "typea">
                                <a href = "#" class = "aa">Black Rotating Chair</a>
                                <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                            </div>   
                            <a href = "#" class = "pricea aa">800 EGP</a>
                    </div>
                </div>
            </div>
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/flasha.png" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                        <div class = "typea">
                            <a href = "#" class = "aa">Flash Drive</a>
                            <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                        </div>   
                        <a href = "#" class = "pricea aa">150 EGP</a>
                    </div>
                </div>
            </div>   
        </div>
        <div class="row align-items-center" style = "height : 500px">
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/micro.jpg" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                        <div class = "typea">
                            <a href = "#" class = "aa">Microwave </a>
                            <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                        </div>   
                        <a href = "#" class = "pricea aa">1999 EGP</a>
                    </div>
                </div>
            </div>
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/table.jpg" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                        <div class = "typea">
                            <a href = "#" class = "aa">Foldable Table</a>
                            <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                        </div>   
                        <a href = "#" class = "pricea aa">500 EGP</a>
                    </div>
                </div>
            </div>
            <div class="col" style = "height : 550px">
                <div class = "boxa">
                    <div class = "slide-imga">
                        <img src = "Images/beanbag.png" alt = "1">
                        <div class = "overlaya">
                            <a href = "#" class = "view-btna" >View</a>
                        </div>
                    </div>
                    <div class = "detail-boxa">
                        <div class = "typea">
                            <a href = "#" class = "aa">Waterproof Bean Bag chair</a>
                            <span class = "spana">Sold by <a href = "#">SellerName</a></span>
                        </div>   
                        <a href = "#" class = "pricea aa">650 EGP</a>
                    </div>
                </div>
            </div>
        </div>
