...
<body>
    ...
    <div>
        <div class = "container">
          <article>
            <h1 class="page-title " style="text-align: center;">ABOUT US</h1> 
            <p>The Outlet was created for the sole purpose of bringing together new and exclusive products. 
                We endeavour to be constantly engaged, 
                maintaining close ties to designers and trend setters. </p>
            <h3>OUR PRODUCTS</h3>
            <p>Our products are meant to complement your Taste. 
                With the help of our fashion experts we manage to bring you exclusive and exciting Clothes directly from the manufacturer.</p>          
          </article>
          <aside>
            <h3>WHY US?</h3>
            <p>100% Money Back Guarantee Free World Wide Shipping Exclusive Clothes 24H Coustumer Support</p>
          </aside>
        </div>
    </div>
    ...
    <div class = "container">
        <article>
          <h1 class="page-title" style="text-align: center;">PRIVACY POLICY</h1> 
          <p>This Privacy Policy describes how your personal information is collected and used, 
              and shared when you visit or make a purchase from The Outlet.</p>
          ...
          <p>We collect Device Information using the following technologies:
              <ul>
                  <li>“Cookies” are data files that are placed on your device or computer and often include an anonymous unique identifier. 
                      For more information about cookies, and how to disable cookies, Click <a href = http://www.allaboutcookies.org.>here</a></li>
                  <li>“Log files” track actions occurring on the Site, and collect data including your IP address, 
                      browser type, Internet service provider, referring/exit pages, and date/time stamps.</li>
    ...
    <section>
        <div class = "container">
          <article>
            <h1 class="page-title" style="text-align: center;">HERE TO HELP</h1> 
            <p>Call us : +1 (747) 848-4985<br> From 10AM - 5PM (EST TIME)  </p>
             <p>E-mail us on : contact@MONTERO.com</p>
          </article>
        </div>
      </section>
